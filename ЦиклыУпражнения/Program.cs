...
///<return>Вывод на консолько результат умножения 2х чисел в случает правильного ввода данных иначе сообщение об ошибке и запрос повторного ввода данных</return>
void methodFour()
{
    bool inputCheck;
    while (true)
