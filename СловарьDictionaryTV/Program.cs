...
/* Получение элементов
Для обращения к элементам из словаря применяется их ключ, который передается в 
квадратных скобках:  словарь[ключ] Так можем получить и изменить элементы словаря */

var people7 = new Dictionary<int, string>()
{
    [5] = "Tom",
    [6] = "Sam",
    [7] = "Bob",
